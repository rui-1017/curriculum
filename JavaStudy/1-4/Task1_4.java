...
public class Task1_4 {
    ...
    System.out.println("ログイン成功です");
       ...
       else if (name.equals(USER_NAME) && pass.equals(CONST_MSG_ERROR_PASS)) {
    System.out.println("パスワードに誤りがあります");
       ...
       else if (name.equals(USER_PASSWORD) && pass.equals(CONST_MSG_ERROR_NAME)) {
    System.out.println("名前に誤りがあります");
       ...
       //定数を使用して「 入力情報に誤りがあります。 」と出力してください。
         else if (name.equals(CONST_MSG_ERROR_NAME) && pass.equals(CONST_MSG_ERROR_PASS)) {
